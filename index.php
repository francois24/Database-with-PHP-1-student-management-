...
if (isset($_GET['searchbtn'])){
    ...
    $sql = "SELECT * FROM test_table WHERE lastname like '%$search%' OR firstname like'%$search%'";
...
<body >
    ...
    <table class="table table-striped-columns">
        ...
        <tbody>
            <?php do { ?>
            <tr>
                <td><a href="details.php?ID=<?php echo $row['ID'];?>" class='text-decoration-none text-black'>Details</a></td>
